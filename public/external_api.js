    ...
    function (e, t) {
      ...
      function o() {
        ...
        if (!(n[t] < e.level))
          for (
            var a =
                !(e.options.disableCallerInfo || r.disableCallerInfo) && s(),
              c = i.concat(e.transports),
              l = 0;
            l < c.length;
            l++
          ) {
    ...
    function (e, t, n) {
      ...
      function h(e) {
        ...
        if (
          ...
          (i = n.exec(e)),
          i &&
            ((t.protocol = i[1].toLowerCase()), (e = e.substring(n.lastIndex))),
          (n = new RegExp("^(//[^/?#]+)", "gi")),
          (i = n.exec(e)),
          i)
        ) {
      ...
      function d(e) {
        const { hash: t, host: n, pathname: i, protocol: r, search: s } =
          e || this;
        let o = "";
        return (
          r && (o += r),
      ...
      function p(e) {
        ...
        if (!n.host) {
          ...
          if (t) {
            const { host: e, hostname: r, pathname: s, port: o } = h(
              l("org.jitsi.meet://" + t)
            );
      ...
      class _ {
        ...
        emit(e, ...t) {
          ...
          return (
            ...
            i || this._unprocessedMessages.add(t),
            i
          );
        }
        on(e, t) {
      ...
      function R(e, t = {}) {
        return p(
          (function (e) {
            ...
            return e;
          })({}, t, { url: `https://${e}/#jitsi_meet_external_api_id=${S}` })
        );
      }
      function P(e) {
        let t;
      ...
      class D extends r.a {
        constructor(e, ...t) {
          ...
          (this._parentNode = s),
            (this._url = R(e, {
              ...
              devices: d,
              userInfo: p,
              appData: { localStorageContent: g },
            })),
            this._createIFrame(r, i, u),
            (this._transport = new _({
              backend: new y({
                postisOptions: {
                  allowedOrigin: new URL(this._url).origin,
                  scope: "jitsi_meet_external_api_" + S,
                  window: this._frame.contentWindow,
                },
              }),
            })),
            Array.isArray(h) && h.length > 0 && this.invite(h),
            (this._tmpE2EEKey = f),
        ...
        _createIFrame(e, t, n) {
          const i = "jitsiConferenceFrame" + S;
